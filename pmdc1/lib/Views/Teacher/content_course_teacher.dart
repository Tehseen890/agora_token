...
class Content_Course_Teacher extends StatefulWidget {
    String courseid = "" ;
   String section = "" ;
   Content_Course_Teacher(@required this.courseid,@required this.section) ;

  @override
  _Content_Course_TeacherState createState() => _Content_Course_TeacherState();
}
...
class _Content_Course_TeacherState extends State<Content_Course_Teacher> {
