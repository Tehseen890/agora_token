...
class Assignment_teacher extends StatefulWidget {
  const Assignment_teacher({Key? key}) : super(key: key);

  @override
  _Assignment_teacherState createState() => _Assignment_teacherState();
}
...
class _Assignment_teacherState extends State<Assignment_teacher> {
