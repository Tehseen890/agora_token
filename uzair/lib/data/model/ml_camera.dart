...
import 'package:uzair/data/entity/recognition.dart';
import 'package:uzair/data/model/classifier.dart';
import 'package:uzair/util/image_utils.dart';
  ...
  static Future<List<Recognition>> inference(
    ...
    final classifier = Classifier(
      interpreter: Interpreter.fromAddress(
        int.parse(isolateCamImgData.interpreterAddress.toString()),
      ),
